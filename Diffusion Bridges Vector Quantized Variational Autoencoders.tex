...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\linewidth]{Archi.png}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.49\textwidth]{klmap_comparison.png}
...
\centering
    ...
    \resizebox{.65\textwidth}{!}{\begin{tabular}{ |l||c|c|c| }
        \hline
        & NLL & FID & s/sample \\
        \hline
...
\centering
    ...
    \resizebox{.65\textwidth}{!}{\begin{tabular}{ |l||c|c|c| }
        ...
        Ours  end-to-end               & 1.59 ($\pm 0.27$)\footnote{NLL for end-to-end takes into account the full model including the modified VQ-VAE, and therefore is not directly comparable to the two others.}  &  92 & 0.11s ($\pm 0.5ms$) \\
        \hline
    \end{tabular}}
    \label{tab:cifar}
\end{table}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=2.0]{network_toy.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{codebookstraining.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\linewidth]{cifar_vqvae.png}
...
\begin{figure}[!htb]
    ...
    \includegraphics[width=1.\linewidth]{samples_pixel_cifar.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
    \includegraphics[width=1.\linewidth]{samples_cifar.png}
    \end{minipage}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.9\linewidth]{vqvae_miniImagenet_reconstruction.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1.\linewidth]{samples.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1.\linewidth]{cond_sampling2.png}
    \includegraphics[width=1.\linewidth]{cond_sampling_pixelcnn_train.png}
    \includegraphics[width=1.\linewidth]{cond_sampling_pixelcnn_train2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{media_images_conditional_sampling_chain_14_4.png}
    \includegraphics[width=.8\linewidth]{media_images_conditional_sampling_chain_14_0.png}
    \includegraphics[width=.8\linewidth]{media_images_conditional_sampling_chain_13_4.png}
    \includegraphics[width=.8\linewidth]{media_images_conditional_sampling_chain_14_1.png}
    \includegraphics[width=.8\linewidth]{media_images_conditional_sampling_chain_12_1.png}
    \includegraphics[width=.8\linewidth]{media_images_conditional_sampling_chain_10_4.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{cond_samples2.png}
    \includegraphics[width=.8\linewidth]{cond_sampling_pixelcnn_train.png}
    \includegraphics[width=.8\linewidth]{cond_sampling_pixelcnn_train2.png}
...
\begin{figure}
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \includegraphics[width=1.\linewidth]{cond_sampling_original.jpg}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}

    \includegraphics[width=1.\linewidth]{cond_sampling_pixelcnn.jpg}
        \end{minipage}
